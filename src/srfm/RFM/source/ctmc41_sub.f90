MODULE CTMC41_SUB
CONTAINS
SUBROUTINE CTMC41 ( ILBL ) 
!     
! VERSION
!   01SEP26 AD Renamed from CTMH2O to CTMC41, using H2OC41_DAT
!   27FEB26 AD Checked.
...
! GLOBAL DATA
    ...
    USE H2OC41_DAT ! MT_CKD v4.1 H2O Continuum data
...
!
  ...
  END DO
!
END SUBROUTINE CTMC41
END MODULE CTMC41_SUB
