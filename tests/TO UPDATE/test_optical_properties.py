"""
This code calculates optical properties in an atmosphere - extinction coefficient,
single scatter albedo, phase_function and optionally legendre polynomial coefficients
for the expansion of the phase function.
"""
