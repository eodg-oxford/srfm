...
ax.add_patch(Rectangle((box_lon_min,box_lat_min),0.6,0.6,fill=False,transform=ccrs.PlateCarree()))

#set map extent
extent=plotting.map_extent(center_lon=box_lon_min+0.3,
                         center_lat=box_lat_min+0.3,
                         lon_span=2,
                         lat_span=2
                         )

ax.set_extent(extent,
              crs=ccrs.PlateCarree(central_longitude=box_lon_min+0.3)
              )
