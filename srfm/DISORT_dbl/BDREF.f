...
c FORTRAN 77
c ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      DOUBLE PRECISION FUNCTION BDREF(MU, MUP, DPHI,
     &                     BRDF_TYPE, BRDF_ARG)
...
c +-------------------------------------------------------------------+
c     .. Scalar Arguments ..
      DOUBLE PRECISION      DPHI, MU, MUP, BRDF_ARG(4)
      INTEGER   BRDF_TYPE
c     ..
c     .. Local Scalars ..
      INTEGER   IREF
      DOUBLE PRECISION      B0, H0, HH, W
      DOUBLE PRECISION      PWS, REFRAC_INDEX, BDREF_F
      DOUBLE PRECISION      PI
      DOUBLE PRECISION      RHO0, KAPPA, G  
      DOUBLE PRECISION      K_ISO, K_VOL, K_GEO, ALPHA0 
      LOGICAL   DO_SHADOW
c     ..
...
c +--------------------------------------------------------------------
      IMPLICIT NONE
      DOUBLE PRECISION MUP, MU, DPHI
      DOUBLE PRECISION B0, HH, W, PI
      DOUBLE PRECISION BRDF
      DOUBLE PRECISION CALPHA, ALPHA, P, B, H0, GAMMA, H
...
c +--------------------------------------------------------------------
      IMPLICIT NONE
      DOUBLE PRECISION MU_I, MU_R, DPHI
      DOUBLE PRECISION RHO0, KAPPA, G_HG, H0
      DOUBLE PRECISION BRDF
      DOUBLE PRECISION PI
      DOUBLE PRECISION COS_ALPHA
      DOUBLE PRECISION SIN_I, SIN_R, TAN_I, TAN_R
      DOUBLE PRECISION G_SQ, G, F
...
c +--------------------------------------------------------------------
      IMPLICIT NONE
      DOUBLE PRECISION MU_I, MU_R, DPHI
      DOUBLE PRECISION F_GEO, F_VOL
      DOUBLE PRECISION K_ISO, K_GEO, K_VOL
      DOUBLE PRECISION RATIO_HB, RATIO_BR
      DOUBLE PRECISION BRDF
      DOUBLE PRECISION PI
      DOUBLE PRECISION COS_ALPHA, SIN_ALPHA
      DOUBLE PRECISION COS_ALPHA1
      DOUBLE PRECISION ALPHA
      DOUBLE PRECISION SIN_I, SIN_R, TAN_I, TAN_R
      DOUBLE PRECISION SIN_I1, SIN_R1, COS_I1, COS_R1, TAN_I1, TAN_R1
      DOUBLE PRECISION G_SQ, COS_T, T       
      DOUBLE PRECISION C, ALPHA0
c +--------------------------------------------------------------------
...
c +--------------------------------------------------------------------
      LOGICAL  DO_SHADOW
      DOUBLE PRECISION     REFRAC_INDEX, WS
      DOUBLE PRECISION     SIN_I, SIN_R, MU_I, MU_R, DPHI, BRDF
      DOUBLE PRECISION     COS_THETA, SIGMA_SQ, MU_N_SQ, P
      DOUBLE PRECISION     N_I, N_T, COS_LI, COS_LT, SIN_LI, SIN_LT
      DOUBLE PRECISION     R_S, R_P, R
      DOUBLE PRECISION     SHADOW
      DOUBLE PRECISION     PI
      DOUBLE PRECISION     SHADOW_ETA
...
c +--------------------------------------------------------------------
      DOUBLE PRECISION FUNCTION SHADOW_ETA(COS_THETA, SIGMA_SQ, PI)
c +--------------------------------------------------------------------
...
c +--------------------------------------------------------------------
      ...
      DOUBLE PRECISION MU, SIGMA_SQ, PI
