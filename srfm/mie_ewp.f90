...
!     INPUT
      real(8), intent(in) :: Dx !particle size parameters, >0
...
!     OUTPUT
      real(8), intent(out) :: Dqxt, Dqsc !extinction efficiency and scattering efficiency, same size as Dx
      real(8), intent(out) :: PF(Inp) !particle phase function, size Inp
